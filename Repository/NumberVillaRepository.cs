...
{
    public class NumberVillaRepository : RepositoryGeneric<NumberVilla>, INumberVillaRepository
    {
        private readonly AplicationDbContext _db;

        public NumberVillaRepository(AplicationDbContext db) : base(db) //Al llamar base(db), estás pasando el contexto de base de datos (AplicationDbContext) a la clase
